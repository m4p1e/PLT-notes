...
\begin{definition}
\rm If $B$ is true under the assumption that $A$ is true, formly written $A \supset B$. The corresponed introduction rule as follow \[\infer[\supset I^u]{A \supset B~true}{\deduce[\vdots]{B~true}{\infer[u]{A~true}{}}}\]
\end{definition}
