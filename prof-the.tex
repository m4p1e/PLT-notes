...
\begin{itemize}
	\item $M_0 = \emptyset$.
	\item 如果存在$C \in T$满足$C$ consists of some complements of literals in $M_{j-1} \cup L_j$，那么$M_j = M_{j-1} \cup \overline{L_j}$; otherwise $M_j = M_{j-1} \cup L_j$.
\end{itemize}
最终$M = M_k$. 接下来我们需要说明在$T$不含$\square$的情况下, $M$ is model of $T$. 
