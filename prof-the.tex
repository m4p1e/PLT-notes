...
\]
我们不能在仅拥有一块蛋糕的情况下，选择吃掉了它之后还剩下一块蛋糕，这显然是不正确的. 因此我们将从sequent calculus开始，小心地去掉contraction和weakening来建立linear logic. 首先我们得扩充一下我们之前的sequent，我们之前的sequent全都是\emph{additive form}，这里来扩充一下在classic logic和intuitionistic logic下等价的另外一种形式\emph{multiplicative logic}，相比于additive form它具有更弱一些premises，下面给出它们的对比:
\begin{center}
