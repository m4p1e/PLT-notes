...
\begin{example}
\rm 如果$A$是atom，那么此时的$\subset L$对应的instance为
$$
\infer[\supset L]{\Gamma, a \supset B \to C}{\Gamma, a \supset B \to a & \Gamma, B \to C}
$$
...
\begin{example}
\rm 如果$A$是$A_1 \wedge A_2$，考虑以下logical equivalent:
$$
...
$$
\begin{gathered}
\infer[\supset L]{\Gamma, (A_1 \wedge A_2) \supset B \to C}{\Gamma, (A_1 \wedge A_2) \supset B \to A_1 \wedge A_2 & \Gamma, B \to C}
\end{gathered}
$$
\end{example}
