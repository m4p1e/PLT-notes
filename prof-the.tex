...
\begin{definition}
\rm A finite set (possibly empty) of literals is called a clause and logical connectives. The empty clause is denoted by $\square$.
\end{definition}

\begin{annotation}
\rm 一个clause用什么connective取决于context. 
\end{annotation}
