...
\begin{theorem}
\rm A propositioal formula $C$ is equivalent to the conjunction of the trace formulas of its decomposition inio regular sequents.
\end{theorem}
...
\begin{annotation}
\rm 之前在\ref{pre-H-system}里面简单地提到了Hilbert-style system, 你有没有想过如何把它转换到sequent calculus里面来呢？ 我们得为此构造一个特殊sequent calculus，让它里面只包含一个之前我们提到rule
\[
