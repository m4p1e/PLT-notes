...
\begin{annotation}
\rm 这座需要两边的支撑一样高，给定特定axiomatic modal logic, 我们得到找到与之对应的semantic modal logic，我们的手法就是sketch it from basic Kripke frame，再其上面加钢筋水泥. 当我们尝试建造了一部分之后，我们需要让其make sense，上述lemma利用formula来characterize是一个不错的选择. 
\end{annotation}
