...
\begin{annotation}
\rm 再了解了前面几个关于linear logic的有趣的properties之后，我们来正式构建它. 我们知道classic and intuitionistic logic的deduction都可以依赖sequent calculus, 那么我们linear logic是否也可以依赖sequent calculus大体框架呢？ 这里面有几个需要思考的问题是:
\begin{itemize}
...
\begin{annotation}
\rm 这里我们解释两个名词action和type为了后面更好的说明: 
\begin{itemize}
