...
\begin{theorem}
\rm (\redt{Soundness}) If the sequent $\Gamma \to C$ is derivable in \textsc{G4ip}, then it is derivable in sequent calculus.
\end{theorem}

\begin{theorem}
\rm (\redt{Completeness}) If the sequent $\Gamma \to C$ is derivable in sequent calculus, then it is derivable in \textsc{G4ip}.
\end{theorem}
