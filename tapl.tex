...
\newcommand{\dbracket}[1]{\ensuremath{\left\llbracket\,\begin{gathered}{#1}\end{gathered}\,\right\rrbracket}}
...
\dbracket{\{(l_i:T_i)_{i \in 1 \ldots n}\}} = \{(l_i:\dbracket{T_i})_{i \in 1 \ldots n}\} 
\end{array}
$$
\end{definition}
...
&\dbracket{\infer{\subtyp{S}{T}}{C_1:: \subtyp{S}{U} & C_2:: \subtyp{U}{T}}} =  \lam{\termtype{x}{\dbracket{S}}}{\dbracket{C_2}(\dbracket{C_1}x)} \\
\cdots
\end{aligned}
$$
\end{definition}
